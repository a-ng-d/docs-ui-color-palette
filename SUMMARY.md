...
* [Configure and create the color palette](create-a-color-palette/create-the-color-palette.md)
...
* [Adjust the lightness stops](edit-a-color-palette/tweak-the-lightness-stops.md)
* [Change the source colors](edit-a-color-palette/change-the-starting-colors.md)
* [Create color themes・Pro](edit-a-color-palette/change-the-starting-colors-1.md)
* [Configure the palette](edit-a-color-palette/configure-the-palette.md)

## Manage a color palette

* [Manage the colors](manage-a-color-palette/manage-the-colors.md)

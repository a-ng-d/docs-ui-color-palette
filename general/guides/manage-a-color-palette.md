...
{% hint style="warning" %}
On Figma specifically: you can create as many color modes as you need in the palette itself, but the more modes you manage, the more limits you might meet when syncing them to local variables, since Figma variable modes are capped per plan:

...
* **Figma** — syncs to both local styles and local variables (with color-mode-per-variable-mode support, capped by your Figma plan). See [Sync a color palette to the local library on Figma](https://docs.ui-color-palette.com/figma/guides/sync-a-color-palette-to-the-local-library).
* **Penpot** — syncs to local styles, and separately to Penpot's native design tokens via the plugin API. See [Sync a color palette to the local library on Penpot](https://docs.ui-color-palette.com/penpot/guides/sync-a-color-palette-to-the-local-library) and [Sync a color palette to tokens on Penpot](https://docs.ui-color-palette.com/penpot/guides/sync-a-color-palette-to-tokens).
* **Sketch** — syncs to both local styles and local variables (note: updating previously-synced variables currently breaks their link to the earlier published ones — see the platform guide for details). See [Sync a color palette to the local library on Sketch](https://docs.ui-color-palette.com/sketch/guides/sync-a-color-palette-to-the-local-library).
* **Framer** — syncs to local color styles only; Framer has no variables concept in the same sense as the other platforms. See [Sync a color palette to the local library on Framer](https://docs.ui-color-palette.com/framer/guides/sync-a-color-palette-to-the-local-library).

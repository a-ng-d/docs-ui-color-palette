...
{% hint style="info" %}
You can use a UI color palette across **Figma**, **Penpot**, **Sketch**, and **Framer**. A palette published from any one of these platforms can be added to your files on any of the others — the Master stays the same regardless of which platform published it.
{% endhint %}
{% endstep %}

...
description: >-
  ...
  primitives) accessible from your document.
icon: file-lines
---
...
{% hint style="info" %}
Generation may be slow depending on the complexity of the color palette (this is more noticeable on Penpot and Sketch). Feel free to take a break and grab a coffee after clicking the button to generate.
{% endhint %}
...
{% hint style="danger" %}
Avoid editing the palette directly on the document canvas. The frame/board/artboard named "\_colors﹒do not edit any layer" is by default locked to avoid any updates by hand.
{% endhint %}
...
{% hint style="info" %}
Keep in mind, this is a shortcut because a document is an instance of the palette. It works like the component flow model (master-instance) of your design tool.
{% endhint %}
{% endstep %}

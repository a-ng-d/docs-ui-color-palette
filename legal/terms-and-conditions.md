...
The distribution model of the Service depends on the platform:

- **Figma**: Distributed as a plugin through the **Figma Community**. By installing and using the plugin, you agree to comply with Figma's terms of service and privacy policy. For more information, visit [Figma's website](https://figma.com).
...
## 13. Licensing and Payments

### 13.1 Primary Payment Platform

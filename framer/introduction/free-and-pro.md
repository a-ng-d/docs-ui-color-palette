...
{% hint style="info" %}
The `/basic` vs `/pro` split — what's free, what needs a subscription, and why — is documented once for every UI Color Palette platform: see **[Understanding free and Pro](../../general/introduction/free-and-pro.md)**. The volume limits and synchronization targets below are Framer's own.
{% endhint %}
...
* [generate the palette documentation](../guides/generate-a-color-palette-documentation.md) in the document;

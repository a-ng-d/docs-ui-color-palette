...
Applying a palette to your workspace and shipping it as assets requires `/pro`:
...
* export to code in every format except CSS (native and DTCG tokens, Tailwind, SCSS, Less, Apple, Android, spreadsheets…).

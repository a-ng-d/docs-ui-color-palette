...
description: >-
  ...
  primitives) accessible from your Framer document.
icon: file-lines
---
...
{% hint style="info" %}
Keep in mind, this is a shortcut because a document is an instance of the palette. It works like the Framer component flow model (master-instance).
{% endhint %}
{% endstep %}

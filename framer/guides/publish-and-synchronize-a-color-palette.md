...
* `Share with  community`: The palette can be added by other members of `UI Color Palette`
{% endstep %}
...
{% hint style="info" %}
You can use a UI color palette across **Figma**, **Penpot**, **Sketch,** and **Framer**. Palettes created in **Framer** are compatible with **Penpot**, and those made in **Penpot** can be used in **Sketch**.
{% endhint %}
{% endstep %}

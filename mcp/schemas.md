...
| `preset`                | [`Preset`](schemas.md#preset)     | Shade stop configuration                                                                      |
...
| `colors`                | [`Color[]`](schemas.md#color)     | Source colors — at least one required                                                         |
...
| `POLARIS`          | 1–16                                               | 16  | 100 | EASEOUT\_QUAD |

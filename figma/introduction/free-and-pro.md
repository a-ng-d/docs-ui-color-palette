...
{% hint style="info" %}
Palettes are scoped **per page** on Figma — switching page gives you a different palette set. Penpot works the same way, per page; Framer and Sketch scope palettes per document instead.
{% endhint %}
